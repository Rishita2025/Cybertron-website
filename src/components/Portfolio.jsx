...
const Portfolio = () => {
    return (
        <>
            <div className="mb-b lg:mb-0 py-4 lg-py-0 bg-[#fff2b7]" id='portfolio'>
                <h2 className=" text-center text-3xl text-blue-900 uppercase font-bold">
                Who We Help &<span className='block mt-1'>How We Do It</span> 
                </h2>
             
                <h2 className="mt-4 lg:mt-3 mx-12 text-center text-xl lg:text-xl lg:px-36 font-medium text-black">
                We don’t believe in one-size-fits-all security—because every business, startup, and individual has unique challenges. That’s why we provide customized solutions that adapt to your needs.
          </h2>
                <div className="px-4" data-aos="fade-down" data-aos-delay="600">
                    {/* <div className="grid sm:grid-cols-2 lg:grid-cols-4 lg:mt-10 gap-5 lg:px-16">     
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3 min-h-max">
                            <div className="m-2 text-justify text-sm">
                                <h4 className="font-semibold my-4 text-lg md:text-md text-center mb-4 h-12">For Startups & Entrepreneurs – Secure Growth Without Fear</h4>
                                <h3></h3>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-1 lg:mt-10 gap-5 lg:px-16 h-96">
                        <TabBar/>
                        {/* <LargeCard/> */}
                    </div>
                </div>
